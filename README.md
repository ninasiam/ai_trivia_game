...
Θα φτιάξεις τη δική σου εφαρμογή trivia παιχνιδιού που τροφοδοτείται από AI! Η εφαρμογή θα σε ρωτάει ερωτήσεις, θα κρίνει τις απαντήσεις σου και θα κρατάει το σκορ σου (σχεδόν 🙂‍↔️).
...
Θα χρησιμοποιήσουμε **LangGraph** (σχεδιασμός του AI app ως ροή) και **Ollama** (open - source LLM locally στον υπολογιστή σου!).
...
- Σύνδεση στο internet (για τις trivia ερωτήσεις και το πρώτο pull μοντέλου)
...
| `judge_node` | Το LLM κρίνει την απάντησή σου και ενημερώνει το σκορ (και πάλι σχεδόν 🙂‍↔️) |
