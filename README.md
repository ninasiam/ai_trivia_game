...
Θα φτιάξεις τη δική σου εφαρμογή trivia παιχνιδιού που τροφοδοτείται από AI! Η εφαρμογή θα σε ρωτάει ερωτήσεις, θα κρίνει τις απαντήσεις σου και θα κρατάει το σκορ σου (σχεδόν 😁).
...
| `judge_node` | Το LLM κρίνει την απάντησή σου και ενημερώνει το σκορ (και πάλι σχεδόν 😁! ) |
